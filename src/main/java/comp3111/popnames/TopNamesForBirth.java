...
public class TopNamesForBirth {
	/**
     *getFileParsers
     *This function will get parameters from the UI and use them to get the corresponding
     *data.
    ...
    */ 
     ...
     *@param year year to get the data file
    ...
    */ 
	...
	/**
     *getMaxnum
     *A helper function to get the maximum number of names of a certain gender for a certain year;
     *@param year year the user specific
     *@param gender gender the user specific
